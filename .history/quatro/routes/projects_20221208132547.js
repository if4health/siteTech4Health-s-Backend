...
mongoose.connect(connString, { dbName: DB_NAME, useNewUrlParser: true, useUnifiedTopology: true })
  .then(client => {
    ...
    router.post('/new', async (req, res) => {
      ...
      if(req.body.schoolars2){ project.members.push(req.body.member2); }
      if(req.body.schoolars3){ project.members.push(req.body.member3); }
      if(req.body.schoolars4){ project.members.push(req.body.member4); }
      if(req.body.schoolars5){ project.members.push(req.body.member5); }
      if(req.body.schoolars6){ project.members.push(req.body.member6); }
      if(req.body.schoolars7){ project.members.push(req.body.member7); }
      if(req.body.schoolars8){ project.members.push(req.body.member8); }
      if(req.body.schoolars9){ project.members.push(req.body.member9); }
      if(req.body.schoolars10){ project.members.push(req.body.member10); }

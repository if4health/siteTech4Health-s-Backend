...
mongoose.connect(connString, { dbName: DB_NAME, useNewUrlParser: true, useUnifiedTopology: true })
  .then(client => {
    ...
    router.post('/new', async (req, res) => {
      ...
      project.tittle = req.body.
      project.description = req.body.
      project.vigency = req.body.
      project.coordinator = req.body.
      project.members = req.body.
      project.scholars = req.body.
      project.status = req.body.

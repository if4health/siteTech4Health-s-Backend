...
mongoose.connect(connString, { dbName: DB_NAME, useNewUrlParser: true, useUnifiedTopology: true })
  .then(client => {
    ...
    router.post('/new', async (req, res) => {
      ...
      if(req.body.scholars2){ project.members.push(req.body.2); }
      if(req.body.scholars3){ project.members.push(req.body.3); }
      if(req.body.scholars4){ project.members.push(req.body.4); }
      if(req.body.scholars5){ project.members.push(req.body.5); }
      if(req.body.scholars6){ project.members.push(req.body.6); }
      if(req.body.scholars7){ project.members.push(req.body.7); }
      if(req.body.scholars8){ project.members.push(req.body.8); }
      if(req.body.scholars9){ project.members.push(req.body.9); }
      if(req.body.scholars10){ project.members.push(req.bodyr10); }

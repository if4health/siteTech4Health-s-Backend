...
mongoose.connect(connString, { dbName: DB_NAME, useNewUrlParser: true, useUnifiedTopology: true })
  .then(client => {
    ...
    router.post('/new', async (req, res) => {
      ...
      if(req.body.2){ project.members.push(req.body.member2); }
      if(req.body.3){ project.members.push(req.body.member3); }
      if(req.body.4){ project.members.push(req.body.member4); }
      if(req.body.5){ project.members.push(req.body.member5); }
      if(req.body.6){ project.members.push(req.body.member6); }
      if(req.body.7){ project.members.push(req.body.member7); }
      if(req.body.8){ project.members.push(req.body.member8); }
      if(req.body.9){ project.members.push(req.body.member9); }
      if(req.body.10){ project.members.push(req.body.member10); }

...
mongoose.connect(connString, { dbName: DB_NAME, useNewUrlParser: true, useUnifiedTopology: true })
  .then(client => {
    ...
    router.post('/new', async (req, res) => {
      ...
      if(req.body.member3){ project.members.push(req.body.member2); }
      if(req.body.member4){ project.members.push(req.body.member2); }
      if(req.body.member5){ project.members.push(req.body.member2); }
      if(req.body.member6){ project.members.push(req.body.member2); }
      if(req.body.member7){ project.members.push(req.body.member2); }
      if(req.body.member8){ project.members.push(req.body.member2); }
      if(req.body.member9){ project.members.push(req.body.member2); }
      if(req.body.member10){ project.members.push(req.body.member2); }

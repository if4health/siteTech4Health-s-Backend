...
mongoose.connect(connString, { dbName: DB_NAME, useNewUrlParser: true, useUnifiedTopology: true })
  .then(client => {
    ...
    router.post('/new', async (req, res) => {
      ...
      if(req.body.scholars2){ project.members.push(req.body.scholar2); }
      if(req.body.scholars3){ project.members.push(req.body.scholar3); }
      if(req.body.scholars4){ project.members.push(req.body.scholar4); }
      if(req.body.scholars5){ project.members.push(req.body.scholar5); }
      if(req.body.scholars6){ project.members.push(req.body.scholar6); }
      if(req.body.scholars7){ project.members.push(req.body.scholar7); }
      if(req.body.scholars8){ project.members.push(req.body.scholar8); }
      if(req.body.scholars9){ project.members.push(req.body.scholar9); }
      if(req.body.scholars10){ project.members.push(req.body.scholarr10); }

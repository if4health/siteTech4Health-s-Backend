...
mongoose.connect(connString, { dbName: DB_NAME, useNewUrlParser: true, useUnifiedTopology: true })
  .then(client => {
    ...
    router.post('/new', async (req, res) => {
      ...
      if(req.body.scholars2){ project.members.push(req.body.
        member2); }
      if(req.body.scholars3){ project.members.push(req.body.
        member3); }
      if(req.body.scholars4){ project.members.push(req.body.
        member4); }
      if(req.body.scholars5){ project.members.push(req.body.
        member5); }
      if(req.body.scholars6){ project.members.push(req.body.
        member6); }
      if(req.body.scholars7){ project.members.push(req.body.
        member7); }
      if(req.body.scholars8){ project.members.push(req.body.
        member8); }
      if(req.body.scholars9){ project.members.push(req.body.
        member9); }
      if(req.body.scholars10){ project.members.push(req.body
        .member10); }

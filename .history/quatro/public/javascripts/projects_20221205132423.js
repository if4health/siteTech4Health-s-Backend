...
function newSchoolarInput(){
    scholarCount += 1;
    document.getElementById("#scholars").insertAdjacentHTML("beforeend", `<input class="form-control" type="text" placeholder="Membro" name="member${scholarsCount}" required>`);
}

function newMemberInput(){
    document.getElementById("#members").insertAdjacentHTML("beforeend", (<input class="form-control" type="text" placeholder="Membro" id="member" name="member" required></input>)
}

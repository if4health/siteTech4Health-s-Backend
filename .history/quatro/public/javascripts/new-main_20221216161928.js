...
const  = document.querySelectorAll('.delete-student')

for (let i = 0; i < de.length; i++) {
  de[i].addEventListener('click', _ => {
    fetch('/students/delete/'+de[i].name, {
      method: 'delete',
      headers: { 'Content-Type': 'application/json' },
    })
      .then(res => {
...
const updateStoneId = document.querySelectorAll('.update-student')
